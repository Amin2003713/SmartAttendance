...
namespace Shifty.Application.Users.Validators.Commands.ForgotPassword;
...
public class ForgotPasswordRequestValidator : AbstractValidator<ForgotPasswordRequest>
{
    public ForgotPasswordRequestValidator(IStringLocalizer<ForgotPasswordRequestValidator> localizer)
    {
        ...
        RuleFor(x => x.UserName)
            ...
            .Matches(@"^\d{10,}$")
            .WithMessage(localizer["Phone number must have at least 10 digits."]
                .Value); // "شماره تلفن باید حداقل ۱۰ رقم باشد."
