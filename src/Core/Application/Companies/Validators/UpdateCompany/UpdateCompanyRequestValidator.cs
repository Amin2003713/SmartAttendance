...
namespace Shifty.Application.Companies.Validators.UpdateCompany;
...
public class UpdateCompanyRequestValidator : AbstractValidator<UpdateCompanyRequest>
{
    public UpdateCompanyRequestValidator(IStringLocalizer<UpdateCompanyRequestValidator> localizer)
    {
        ...
        RuleFor(x => x.PhoneNumber)
            ...
            .Matches(@"^(?:\+98|0)?9\d{9}$")
            .WithMessage(localizer["Phone number must be a valid Iranian mobile number (09XXXXXXXXX or +989XXXXXXXXX)"]
                .Value);
