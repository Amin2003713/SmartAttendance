    ...
    public InitialCompanyRequestValidator()
{
    ...
    RuleFor(x => x.FirstName)
        ...
        .MaximumLength(150).WithMessage("نام  نباید بیشتر از 150 کاراکتر باشد.");


    RuleFor(x => x.LastName).NotEmpty().WithMessage("نام خانوادگی الزامی است.").MaximumLength(150).WithMessage("نام خانوادگی نباید بیشتر از 150 کاراکتر باشد.");
