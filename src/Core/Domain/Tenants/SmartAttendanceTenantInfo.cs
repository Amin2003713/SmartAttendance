...
public class SmartAttendanceTenantInfo : ITenantInfo
{
    ...
    {
        return
            $"Server={ApplicationConstant.Sql.DbServer};Database=SmartAttendance.{Identifier!.Replace("-", "_")};{ApplicationConstant.Sql.MultipleActiveResultSets};{ApplicationConstant.Sql.Encrypt};{ApplicationConstant.Sql.UserNameAndPass}";
    }
