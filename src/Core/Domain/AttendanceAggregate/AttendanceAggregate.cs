...
public sealed class AttendanceAggregate : AggregateRoot<AttendanceId>
{
	...
	public async Task RecordByGpsAsync(GPSCoordinate studentLocation, GPSCoordinate gateLocation, double allowedRadiusMeters, IAttendanceValidationService validator, CancellationToken ct = default)
	{
		if (_isRecorded) return;
