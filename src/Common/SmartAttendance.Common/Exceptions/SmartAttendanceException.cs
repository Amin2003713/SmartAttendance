...
public class SmartAttendanceException : Exception
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="SmartAttendanceException" /> class with specified parameters.
    /// </summary>
    ...
    {
        return new SmartAttendanceException(message);
    }
    ...
    {
        return new SmartAttendanceException(message, additionalData: additionalData);
    }
    ...
    {
        return new SmartAttendanceException(httpStatusCode: httpStatusCode, message: message);
    }
...
#region Predefined API Exceptions
    ...
    {
        return new SmartAttendanceException(message, HttpStatusCode.BadRequest, null, additionalData);
    }
