...
namespace Ipa.Framework.Apis.Analytics;

public static class AnalyticsExtensions
{
    private static readonly ActivitySource ActivitySource = new(Assembly.GetCallingAssembly().GetName().ToString());

    private static readonly ResourceBuilder ResourceBuilder =
