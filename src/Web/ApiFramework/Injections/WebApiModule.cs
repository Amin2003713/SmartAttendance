...
{
    public static void AddWebApi<TUser, TTenantInfo, TTenantDbContext, TServiceDb, TStartUp, TApplication>(
        ...
        where TTenantDbContext : EFCoreStoreDbContext<TTenantInfo>
    {
        ...
        services.AddCustomIdentity<TUser, TServiceDb>();
    ...
    private static void AddCustomIdentity<TUser, TDbContext>(this IServiceCollection services)
        where TUser : class
        where TDbContext : DbContext
    {
        services.AddIdentity<TUser , IdentityRole<Guid>>(identityOptions =>
            {
                //Password Settings
        ...
        services.AddAuthentication(options =>
            ...
            .AddJwtBearer(options =>
            {
                ...
                options.Events = new JwtBearerEvents
                {
                    ...
                    {
                        var tenantSecretKey =
                            context.HttpContext.GetMultiTenantContext<UniversityTenantInfo>().TenantInfo !=
                            null
