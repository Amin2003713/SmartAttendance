...
namespace Shifty.Persistence.Migrations.Tenant
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable("TenantInfo" ,
                table => new
                {
                ...
                constraints: table =>
                             {
                                 ...
                                 table.ForeignKey("FK_TenantInfo_TenantAdmin_UserId" ,
                                     x => x.UserId ,
                                     "TenantAdmin" ,
                                     "Id" ,
                ...
                constraints: table =>
                             {
                                 ...
                                 table.ForeignKey("FK_Payments_TenantInfo_ShiftyTenantInfoId" ,
            ...
            migrationBuilder.CreateIndex("IX_Payments_ShiftyTenantInfoId" , "Payments" , "ShiftyTenantInfoId");

            migrationBuilder.CreateIndex("IX_TenantInfo_Identifier" , "TenantInfo" , "Identifier" , unique: true);

            migrationBuilder.CreateIndex("IX_TenantInfo_UserId" , "TenantInfo" , "UserId");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "TenantInfo");
