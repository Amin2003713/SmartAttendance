        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TenantInfo_TenantAdmin_UserId",
                        column: x => x.UserId,
                        principalTable: "TenantAdmin",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantInfosId = table.Column<string>(type: "nvarchar(64)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Companies_TenantInfo_TenantInfosId",
                        column: x => x.TenantInfosId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_TenantInfo_ShiftyTenantInfoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Companies_TenantInfosId",
                table: "Companies",
                column: "TenantInfosId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Payments_ShiftyTenantInfoId",
                table: "Payments",
