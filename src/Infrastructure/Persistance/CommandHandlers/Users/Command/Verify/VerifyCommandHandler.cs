...
public class VerifyCommandHandler(UserManager<User> userManager , IRepository<User> userRepository) : IRequestHandler<VerifyPhoneNumberCommand , VerifyPhoneNumberResponse>
{
