...
{
    public class RefreshTokenRepository(WriteOnlyDbContext dbContext)
        : Repository<RefreshToken , WriteOnlyDbContext>(dbContext) , IRefreshTokenRepository , IScopedDependency
    {
